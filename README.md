...
In version 1.2.3, there are 39 seasonal frames, 13 festival frames, 38 map specific frames, and 1 event specific frames. The assets are meant to be overlayed on top of existing UI, in some case this led to minimal compatibility with UI recolor mod. Presented is how portrait frames configured. 
